...
| [TC-040](test-cases/TC-040-saving-to-search-history-an-item-in-existing-history-in-upper-case.md) | Сохранение в историю поиска товара существующего в истории в верхнем регистре | Пройден |
